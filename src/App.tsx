...
const App = () => {
  return (
    <div>
      ...
      <div className="container mx-auto bg-gray-200 rounded-xl shadow border p-8 m-10 flex flex-row flex-wrap">
        <div className="border bg-gray-200 text-4xl font-extrabold p-7 m-4">
          Book title
        </div>
        <div className="border bg-gray-200 text-4xl font-extrabold p-7 m-4">
          Book author
